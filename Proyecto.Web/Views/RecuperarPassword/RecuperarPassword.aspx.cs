        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dsConsulta.Tables[0].Rows.Count > 0)
                {
                    ...
                    stCuerpoHTML += "</p>";
                    stCuerpoHTML += "<p style='color: #b3b3b3; font-size: 12px; text-align: center;margin: 30px 0 0'>Copyright © CRM 2021</p>";
                    stCuerpoHTML += "</div>";
                    stCuerpoHTML += "</td>";
                    stCuerpoHTML += "</tr>";
                    stCuerpoHTML += "</table>";
                    ...
                    throw new Exception("No se encontró información asociada a este correo");
            }
            catch (Exception ex)
            {
