    ...
    public partial class CrearCuenta : System.Web.UI.Page
    {
        ...
        protected void btnCrear_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //VALIDAMOS LA SELECCIÓN DE UNA IMAGEN
                if (fuImagen.HasFile)
                {
                    ...
                    fuImagen.PostedFile.SaveAs(stRuta);//GUARDANDO EL ARCHIVO DENTR DEL PROYECTO
                    ...
                    ClientScript.RegisterStartupScript(this.GetType(), "mensaje", "<script>swal('¡Mensaje!','" + obCrearCuentaController.setCrearCuentaController(obclsUsuarios, 1)
                    +"!', 'success')</script>");
                }
            }
            catch (Exception ex)
